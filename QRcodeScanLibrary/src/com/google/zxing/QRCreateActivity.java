...
import com.google.zxing.util.SaveImageInBackgroundData;
import com.google.zxing.util.SaveImageInBackgroundTask;
...
public class QRCreateActivity extends Activity {
	...
	public static final int[] COLORS = { COLOR_BLUE, COLOR_RED, COLOR_PURPLE, COLOR_BLACK };
...
//		mApp = App.getApp();
	...
	public void createQRcode(String content, int style) {
		try {
			...
			if (mQRBitmap != null && mQRView != null)
	...
	private BitMatrix createQRBitMatrix(String content) throws WriterException {

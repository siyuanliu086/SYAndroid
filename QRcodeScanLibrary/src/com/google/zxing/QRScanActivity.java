...
/**
 * @TiTle QRScanActivity.java
 * @Package com.zhangxy.HeWarrants.activity
 * @Description 二维码扫描
 * @Date 2016年3月23日
 * @Author siyuan
 * @Refactor 
...
//		ToastUtil.showShortToast(mContext, resultString);
		...
		if (resultCode == RESULT_OK) {
			...
			case REQUEST_CODE:				
				...
				try {
					...
					mProgress = new ProgressDialog(QRScanActivity.this);
	...
	private Handler mHandler = new Handler(Looper.getMainLooper()) {
		...
		public void handleMessage(Message msg) {
			...
			case PARSE_BARCODE_SUC:
				...
				Intent intent = new Intent();
				intent.putExtra("qr_code", (String)msg.obj);
				setResult(0x20, intent);
				finish();
				break;
			case PARSE_BARCODE_FAIL:
				Toast.makeText(mContext, "扫描失败，请稍后重试！", Toast.LENGTH_SHORT).show();
				break;
			}
		}
	};

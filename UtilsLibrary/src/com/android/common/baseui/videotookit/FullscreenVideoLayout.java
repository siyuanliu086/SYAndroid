...
public class FullscreenVideoLayout extends FullscreenVideoView implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnPreparedListener, View.OnTouchListener {
    ...
    protected void init() {
        ...
        this.videoControlsView = inflater.inflate(R.layout.utilslib_layout_videocontrols, this, false);
...
//            videoControlsView.setVisibility(View.VISIBLE);
    ...
    protected void updateControls() {
        ...
        if (getCurrentState() == State.STARTED) {
            icon = context.getResources().getDrawable(R.drawable.utilslib_video_fvl_selector_pause);
        } else {
            icon = context.getResources().getDrawable(R.drawable.utilslib_video_fvl_selector_play);
        }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (videoControlsView != null) {
                if (videoControlsView.getVisibility() == View.INVISIBLE)

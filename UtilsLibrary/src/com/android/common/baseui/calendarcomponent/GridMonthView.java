...
import com.android.common.baseui.calendarcomponent.theme.DefaultDayTheme;
...
public class GridMonthView extends MonthView {
    ...
    protected void createTheme() {
        theme = new DefaultDayTheme(getContext());
    }
}

...
import com.android.common.baseui.quickreturnscrolls.ListViewScrollObserver.OnListViewScrollListener;
...
public class QuickReturnHeaderHelper implements OnGlobalLayoutListener {
    ...
    public View createView() {
        ...
        content = (ViewGroup) inflater.inflate(contentResId, null);
...
//        listView = (ListView) content.findViewById(android.R.id.list);
    ...
    private void createListView() {
        root = (FrameLayout) inflater.inflate(R.layout.utilslib_layout_listview_container, null);
    ...
    private void createScrollView() {
        root = (FrameLayout) inflater.inflate(R.layout.utilslib_layout_scrollview_container, null);

        NotifyingScrollView scrollView = (NotifyingScrollView) root.findViewById(R.id.quickreturn_scroll_view);
        scrollView.setOnScrollChangedListener(mOnScrollChangedListener);

        root.addView(realHeader, realHeaderLayoutParams);

        mContentContainer = (ViewGroup) root.findViewById(R.id.quickreturn_container);
        mContentContainer.addView(content);

        dummyHeader = mContentContainer.findViewById(R.id.quickreturn_content_top_margin);

...
public class AlertView {
    ...
    protected void initViews(){
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.utilslib_layout_alertview, decorView, false);
        ...
        switch (style){
            case ActionSheet:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.utilslib_horizontal_margin);
            ...
            case Alert:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.utilslib_28dp);
    ...
    protected void initListView(){
        ...
        if(cancel != null && style == Style.Alert){
            View itemView = LayoutInflater.from(context).inflate(R.layout.utilslib_layout_alertview_item_alertbutton, null);
            ...
            tvAlert.setTextColor(context.getResources().getColor(R.color.utilslib_text_black9));
            tvAlert.setBackgroundResource(R.drawable.utilslib_alert_bg_alertbutton_bottom);
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.utilslib_layout_alertview_actionsheet,contentContainer);
    ...
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.utilslib_layout_alertview_alert, contentContainer);
        initHeaderView(viewGroup);
        ...
        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
            ...
            for (int i = 0; i < mDatas.size(); i ++) {
                ...
                if (i != 0){
                    ...
                    divier.setBackgroundColor(context.getResources().getColor(R.color.utilslib_lines_color));
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int)context.getResources().getDimension(R.dimen.utilslib_line_divier), LinearLayout.LayoutParams.MATCH_PARENT);
                ...
                if(mDatas.size() == 1){
                    ...
                    tvAlert.setBackgroundResource(R.drawable.utilslib_alert_bg_alertbutton_left);
                }
                else if(i == mDatas.size() - 1){//设置最右边的按钮效果
                    tvAlert.setBackgroundResource(R.drawable.utilslib_alert_bg_alertbutton_right);
                }
                ...
                if (data == cancel){
                    tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
                    tvAlert.setTextColor(context.getResources().getColor(R.color.utilslib_text_black6));
                    tvAlert.setOnClickListener(new OnTextClickListener(CANCELPOSITION));
                    position = position - 1;
                }
                //高亮按钮的样式
    ...
    public void setMarginBottom(int marginBottom){
        ...
        int margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.utilslib_margin10);

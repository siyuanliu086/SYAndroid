 ...
 */
package com.android.common.baseui.waterdroplistview;
...
public class WaterDropListViewFooter extends LinearLayout {
	...
	public void setState(STATE state) {
		...
		if (state == STATE.ready) {
			...
			mHintView.setText(getResources().getString(R.string.utilslib_listfooterview_ready));
			...
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(getResources().getString(R.string.utilslib_listfooterview_normal));
		}
	}
	...
	private void initView(Context context) {
		mContext = context;
		LinearLayout moreView = (LinearLayout)LayoutInflater.from(mContext).inflate(R.layout.utilslib_layout_waterdroplistview_footer, null);
		addView(moreView);

        ...
        if (attrs != null) {
            ...
            try {
                ...
                if(a.hasValue(R.styleable.WaterDropView_waterdrop_color)){
                   int waterDropColor =  a.getColor(R.styleable.WaterDropView_waterdrop_color, context.getResources().getColor(R.color.utilslib_theme_color_green));//Color.GRAY);
...
//        mPaint.setColor(Color.GRAY);
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.utilslib_refresh_arrow);//圆圈中心显示图

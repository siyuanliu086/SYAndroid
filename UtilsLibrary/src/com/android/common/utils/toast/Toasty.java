...
public class Toasty {
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.utilslib_toasty_ic_error_outline_white_48dp),
    ...
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.utilslib_toasty_ic_info_outline_white_48dp),
    ...
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.utilslib_toasty_ic_check_white_48dp),
    ...
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.utilslib_toasty_ic_clear_white_48dp),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.utilslib_layout_toasty, null);
        final ImageView toastIcon = (ImageView) toastLayout.findViewById(R.id.utilslib_toasty_icon);
        final TextView toastTextView = (TextView) toastLayout.findViewById(R.id.utilslib_toasty_text);
        Drawable drawableFrame;

        if (shouldTint)
            drawableFrame = ToastyUtils.tint9PatchDrawableFrame(context, tintColor);
        else
            drawableFrame = ToastyUtils.getDrawable(context, R.drawable.utilslib_toasty_bgframe);

...
public class CheckIdCard {
	...
	public static String chekIdCard(String idCardInput) {
		...
		int sex = Integer.valueOf(idCardInput.substring(idCardInput.length() - 2, idCardInput.length() - 1)) % 2 == 1 ? MAN_SEX : WOMAN_SEX;
	 ...
	 * 验证18位身份证号码校验码是否符合规则
	 */
	private static String checkCheckCode(int idCardType, String arrIdCard) {
		int sigma = 0;
